...
public class ControlDragAndDropForSeven : MonoBehaviour
{
    [Header("Options")]
        ...
        private void CheckCorrectness()
{
    ...
    if (correctCount >= 7) // Assuming you want at least 7 correct answers
    {
    ...
    if (correctCount >= 7) // Assuming you want at least 2 correct answers
{
    soundControl.gameCompleteSound();
    StartCoroutine(ShowGameCompletionPanel());
}
